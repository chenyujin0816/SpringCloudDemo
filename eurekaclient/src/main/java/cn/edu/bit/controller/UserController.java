...
public class UserController {
    ...
    public Result login(@Validated @RequestBody LoginDto loginDto, HttpServletResponse response) {
        ...
        return Result.succ(MapUtil.builder()
                ...
                .put("class_number", user.getClassNumber())
                .map()
        );
    }
    @PostMapping("/changePassword")
    public Result changePassword(@Validated @RequestBody ChangePasswordDto changePasswordDto, HttpServletResponse response) throws ParseException {
    ...
    public Result register(@Validated @RequestBody RegisterDto registerDto, HttpServletResponse response) throws ParseException {
...
//            newUser.setClassNumber(registerDto.getClassNumber());
    ...
    public void setLoginTime(@Validated @RequestBody LoginTimeDto loginTimeDto) throws ParseException {
